...
class Scoreboard():
    ...
    def prep_high_score(self):
        ...
        # score_str = str(self.stats.score)
        #TODO round 函数 format 函数
        score_str = int(round(self.stats.high_score, -1))
        hight_score_str  = "{:,}".format(score_str)
    ...
    def prep_level(self):
        ...
        # self.level_rect.top = self.screen_rect.bottom + 100
        # 先指定位置
